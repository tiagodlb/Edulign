...
const mockState: AuthState = {
  ...
  isAuthenticated: true,
  loginError: null,
  sessionExpiry: new Date(Date.now() + 1000 * 60 * 60) // 1 hora
}
...
const mockAuthContext: AuthContextValue = {
  ...
  hasPermission: (permission) => mockUser.permissions?.includes(permission) || false,
  isAdmin: true,
  isProfessor: false,
  isStudent: false,
  getAuthToken: () => mockState.token,
  isTokenExpired: () => false
}

const AuthContext = createContext<AuthContextValue>(mockAuthContext)
